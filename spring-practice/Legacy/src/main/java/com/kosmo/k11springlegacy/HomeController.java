...
public class HomeController {
	...
	public String helloSpring(Model model) {
		...
		웹브라우저에 출력함.
		뷰의 기본 경로 : /K11SpringLegacy/src/main/webapp/WEB-INF/views 하위이다.
		 */
		return "HelloSpring"; //여기서(return에서) HelloSpring를 복사하여 views 폴더 하위에 jsp파일을 만들었음.
	}
