...
public class DIController {
	...
	//위의 mydi1와 코드형식이 같기 때문에 여기 주석은 위에 비해 간단. (정리식으로 보자)
	@RequestMapping("/di/mydi2.do")
	public ModelAndView mydi2(Model model) {
		ModelAndView mv = new ModelAndView();
		
		// XML설정파일을 기반으로 생성한 컨텍스트를 통해 주입받는다.
