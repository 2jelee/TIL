...
public class SetterCall {
	public static void main(String[] args) throws Exception{
		...
		Class<?> type = Class.forName("com.fc.ch2.MyDate");
...
method=public void com.fc.ch2.MyDate.setYear(int)
method=public void com.fc.ch2.MyDate.setMonth(int)
method=public void com.fc.ch2.MyDate.setDay(int)
[private int com.fc.ch2.MyDate.year, private int com.fc.ch2.MyDate.month, private int com.fc.ch2.MyDate.day]
