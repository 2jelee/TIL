...
<!--  
	JSP파일에서 EL을 통해 메소드를 호출하기 위해 지시어를 통한
	선언문을 먼저 기술해야 한다.
...
<%-- <%@ taglib prefix="my" uri="myTagLibTld" %> <!-- web.xml에 등록한 uri의 별칭을 통해서도 지시어를 설정할 수 O --> --%>
<!DOCTYPE html> 
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<ol> 
		<li>
			my:isNumber("100") => ${my:isNumber("100") } <!-- 접두어(prefix로 my를 선언했음)를 통해 메소드를 호출함  -->
		</li>
		<li>
