...
<%-- <%@ tablib prefix="my" uri="MyTagLibTld" %> <!-- 접두어 my --> --%>

<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>Choose~When~Otherwise 태그 </title>
</head>
<body>
	<!-- 										500 error  rerereerrerer    & 연습문제 시, 지시어 문제... 확인
	choose 태그
		: if태그와는 다르게 여러 조건이 있는 경우 사용함.
