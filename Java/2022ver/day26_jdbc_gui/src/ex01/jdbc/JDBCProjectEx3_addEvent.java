...
public class JDBCProjectEx3_addEvent extends JFrame implements ActionListener{
	// [component 객체 선언]
	...
	// [생성자 함수] - 멤버변수 초기화 담당
	public JDBCProjectEx3_addEvent(){
		setTitle("고객 정보 입력 폼");
...
//			switch (JOptionPane.showConfirmDialog(null, message, title, optionType)) {
