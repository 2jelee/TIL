...
public class MainActivity extends AppCompatActivity {
    ...
    ListView listView;
    int[] profileImg = {
            R.drawable.actor01, R.drawable.actor02, R.drawable.actor03, R.drawable.actor04, R.drawable.actor05,
            R.drawable.actor06, R.drawable.actor07, R.drawable.actor08, R.drawable.actor09, R.drawable.actor10,
            R.drawable.actor11, R.drawable.actor12
    };
    //리스트뷰에 출력할 항목을 위한 변수
    ...
    private void getJsonParser() {
        ...
        try {
            //읽어온 JSON데이터를 객체이므로 JSONObject로 파싱한다.
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                String loginInfo = String.format("아뒤:%s,비번:%s", user, pass);
                ...
                해당 컬렉션에 저장된 값을 어뎁터 객체에서 데이터로 사용하게된다.
                 */
