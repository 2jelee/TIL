...
<table border="1" width="90%">
    ...
    <tr>
    	...
    	<tr>
    		...
    		<!-- 비회원제 게시판의 경우 수정, 삭제를 위해 먼저 비밀번호 검증을 진행해야 한다.
    		따라서 동일한 요청명으로 진입하는 대신 파라미터 mode를 통해 수정/삭제를 구분하여 분기한다. -->
    		<button type="button"
...
<!-- 해당 게시물의 일련번호로 댓글 테이블의 참조키가 된다.(마치 FK처럼) -->
...
<!--
 	HTML5에서 지원하는 앵커(Anchor)기능으로 해당 페이지에서
 	특정 위치를 로드하고 싶을 때 아래와 같이 <a태그에 name속성을 부여함.
 	사용 시에는 쿼리스트링 마지막에 #앵커명 형태로 사용하면 됨.
 -->
