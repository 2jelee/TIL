...
include 'header.php';
?>
<form name="updateSubmit" id="updateSubmit" action="update_ok.php/<?php echo $board['idx']; ?>" method="post">
    <div id="container">
        <label>작 성 자 :</label>&nbsp<?=$userid?>
        <form action="update_ok.php/<?php echo $board['idx']; ?>" method="post">
        <br><br>
        <div class="form-group">
            <label for="title" class="form-label">제 목
                <input type="textarea" class="form-control" id="title" name="title" rows="3" value="<?=$board['title']?>" style="width: 1100px; height: auto">
            </label>
        </div>
        <div class="form-group">
