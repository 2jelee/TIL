...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                첫번째는 요청URL, 두번째와 세번째는 서버로 전송할 아이디/패스워드이다.

                "http://192.168.219.104:8081/jsonrestapi/android/memberLogin.do",
                 */
                new AsyncHttpServer().execute(
                        "http://192.168.219.100:8081/jsonerstapi/android/memberLogin.do",
        ...
        dialog.setCancelable(true);//back키를 누르면 대화상자가 닫힘
    ...
    class AsyncHttpServer extends AsyncTask<String, Void, String>
    {
        ...
        //통신중 진행사항은 해당 메소드에서 확인(여기서는 사용 안함)
        @Override
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                {
                "isLogin":1,
                "memberInfo":{"id":"kosmo","pass":"1234","name":"코스모인","regidate":"2021-05-17"}
                }
                */
                //JSON 객체를 1차로 파싱함
                ...
                if(success==1){
                    sb.append("로그인성공^^\n");
                    //객체안에 회원정보를 저장한 또 하나의 JSON객체가 있으므로 파싱
